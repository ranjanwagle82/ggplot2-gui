...
TITLE GUI_ggplot2 Launcher

echo ==========================================
echo      Starting GUI_ggplot2...
echo ==========================================
...
echo [INFO] Rscript not in PATH. Checking Registry...
...
echo [INFO] Registry check failed. Searching Program Files...
SET "LATEST_R="
...
:LaunchApp
echo [INFO] Launching app.R...
echo.

%RSCRIPT_PATH% -e "if (require('shiny', quietly=TRUE) == FALSE) install.packages('shiny', repos='https://cran.rstudio.com/'); shiny::runApp('app.R', launch.browser=TRUE)"
